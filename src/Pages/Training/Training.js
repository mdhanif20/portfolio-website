        ...
        <> 
         <Grid sx={{py:10,background:"#1E2132"}} item xs={12} sm={6}  >
                            <Card sx={{ width: "100%",pt:1,pb:3 }}>
                                <CardMedia
                                    component="img"
                                    style={{padding:"20px 0px",width:"90%",height:"300px", margin:"auto"}}
                                    image={data.InstitutionImg}
                                    alt="green iguana"
                                />
                                <CardContent>
                                    ...
                                    <Typography sx={{fontWeight:"600",fontSize:"1.3rem"}} gutterBottom variant="h6" component="div">
                                    ...
                                    Training Description:  
                                   {
                                        learn? <>
                                            ...
                                            {
                                            data?.CoreKnowledge.slice(0,150) 
                                            }...
